...
function isSKIP(target) {
    return target["__v_skip" /* ReactiveFlags.SKIP */];
}
...
function isReactive(observed) {
    return !!observed && !!observed["__v_isReactive" /* ReactiveFlags.IS_REACTIVE */];
}
function isReadonly(observed) {
    return !!observed && !!observed["__v_isReadonly" /* ReactiveFlags.IS_READONLY */];
}
...
var ComputedImpl = /** @class */ (function () {
    function ComputedImpl(fn) {
        ...
        this._value = null;
        this._dirty = true;
        this._effect = new ReactiveEffect(fn, function () {
            _this._dirty = true;
        });
    }
...
function createRenderer(option) {
    ...
    function mountElement(n2, container, parent) {
        // create Element
        var el = (n2.el = createElement(n2.type));
        var children = n2.children, props = n2.props;
    ...
    function mountChildren(n2, container, parent) {
        n2.children.forEach(function (item) {
    ...
    function processComponent(n2, container, parent) {
        mountComponent(n2, container, parent);
    }
    function mountComponent(n2, container, parent) {
        var instance = createComponentInstance(n2, parent);
    ...
    function setupRenderEffect(instance, vnode, container) {
        effect(function () {
            ...
            if (instance.isMounted) {
                ...
                var subTree = (instance.subTree = instance.render.call(instance.proxy));
...
export { computed, createApp, createElement, createTextVNode, effect, getCurrentInstance, h, inject, insert, isProxy, isReactive, isReadonly, isRef, patchProps, provide, proxyRefs, reactive, readonly, ref, renderSlots, shallowReadonly, stop, unRef };
